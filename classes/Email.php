...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido = '<html>';
        $contenido .=  "<p><strong>Hola " . $this->nombre . "</strong> Haz creado tu cuenta en 
        AppSalon, sólo confirma presionando el siguiente enlace</p>";
    ...
    public function enviarInstrucciones()
    {
        ...
        reestablecer tu password, utiliza este enlace para hacerlo.</p>";
